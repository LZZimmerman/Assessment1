...
#armour dict stores +hp values of the 3 parts of armour
...
while gameOver == False:
    ...
    while townInputCheck == True:
        ...
        if playerInput in ["1", "forest"]:
            forestExp() #runs the massive forest function (lines 910 to 1162)
            townInputCheck = False
        elif playerInput in ["2", "inn"]:
            townInn() #inn function (line 1428)
            townInputCheck = False
        elif playerInput in ["3", "helm", "helmet"]:
            townHelm() #helmshop (line 1166)
            townInputCheck = False
        elif playerInput in ["4", "sword"]:
            townSword() #Sword shop (line 1248)
            townInputCheck = False
        elif playerInput in ["5", "dagger"]:
            townDagger() #Dagger shop (line 1307)
            townInputCheck = False
        elif playerInput in ["6", "staff"]:
            townStaff() #Staff shop (line 1368)
            townInputCheck = False
        else:
            print("invalid input")
